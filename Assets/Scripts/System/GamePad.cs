...
namespace GamepadInput
{
	public static class GamePad
	{
		...
		{
			var code = GetKeycode(button, controlIndex);
		...
		///     指定された軸を返します
		/// </summary>
		/// <param name="axis">AxisかDPad</param>
		/// <param name="controlIndex">コントローラー番号</param>
		...
		public static Vector2 GetAxis(Axis axis, Index controlIndex, bool raw = false)
		{
			...
			{
				case Axis.Dpad:
					xName = "DPad" + (int) controlIndex + "_XAxis";
					yName = "DPad" + (int) controlIndex + "_YAxis";
					break;
				case Axis.LeftStick:
				...
				case Axis.RightStick:
					xName = "R_JoyStick" + (int) controlIndex + "_YAxis";
					yName = "R_JoyStick" + (int) controlIndex + "_XAxis";
					break;
			}
		...
		///     指定されたトリガーを返します
		/// </summary>
		/// <param name="trigger">トリガー名</param>
		/// <param name="controlIndex">コントローラー番号</param>
		...
		public static float GetTrigger(Trigger trigger, Index controlIndex, bool raw = false)
		{
			...
			if (trigger == Trigger.LeftTrigger)
				name = "L_JoyStick" + (int) controlIndex + "_Trigger";
			else if (trigger == Trigger.RightTrigger)
				name = "R_JoyStick" + (int) controlIndex + "_Trigger";
